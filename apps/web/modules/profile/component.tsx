  ...
  return (
    <Stack direction="vertical" gap="xl">
      <Stack direction="vertical" gap="sm">
        <Typography as="h1" variant="display-l">Daniel Cantor</Typography>
        <Typography variant="heading-m" color="accent">Software Engineer · Product Owner</Typography>
      ...
      <Grid columns={{ base: 1, tablet: 3 }} gap="md">
        <Panel><Stack direction="vertical" gap="xs"><Typography variant="body" color="muted">Base</Typography><Typography variant="heading-m">Bogotá, Colombia</Typography></Stack></Panel>
        ...
        <Panel><Stack direction="vertical" gap="xs"><Typography variant="body" color="muted">Disponibilidad</Typography><Typography variant="heading-m">Open to opportunities</Typography></Stack></Panel>
      </Grid>
